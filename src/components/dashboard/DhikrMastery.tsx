...
import { PenSquare, Plus, Trash2, Bot } from "lucide-react";
    ...
    <Card className={cn("h-full flex flex-col", className)}>
      ...
      <CardContent className="flex flex-col flex-grow">
        ...
        <ScrollArea className="flex-grow">
            ...
            {dhikrs?.map((dhikr) => (
                <li key={dhikr.id} className="flex items-start justify-between bg-secondary/50 p-3 rounded-md animate-in fade-in-0 slide-in-from-top-2 duration-300">
